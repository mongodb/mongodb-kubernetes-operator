...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutomationConfigRole) DeepCopyInto(out *AutomationConfigRole) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutomationConfigRole.
func (in *AutomationConfigRole) DeepCopy() *AutomationConfigRole {
	if in == nil {
		return nil
	}
	out := new(AutomationConfigRole)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MongoDBSpec) DeepCopyInto(out *MongoDBSpec) {
	*out = *in
	...
	if in.Roles != nil {
		in, out := &in.Roles, &out.Roles
		*out = make([]AutomationConfigRole, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
