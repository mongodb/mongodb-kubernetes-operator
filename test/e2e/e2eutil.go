...
func UpdateMongoDBResource(ctx *Context, original *mdbv1.MongoDBCommunity, updateFunc func(*mdbv1.MongoDBCommunity)) error {
...
func NewPrometheusConfig(ctx *Context, namespace string) *mdbv1.Prometheus {
	sec := secret.Builder().
		SetName("prom-secret").
...
func ensureObject(ctx *Context, obj k8sClient.Object) error {
	...
	if err != nil {
		...
		err = TestClient.Create(ctx, obj, &CleanupOptions{})
		if err != nil {
			return err
		}
	} else {
