...
func TestReplicaSetMongodPortChangeWithArbiters(t *testing.T) {
	...
	t.Run("Automation config reaches version 3", mongodbtests.AutomationConfigReachesVersion(&mdb, 3))
	t.Run("Automation config reaches version 4", mongodbtests.AutomationConfigReachesVersion(&mdb, 4))
	t.Run("Automation config reaches version 5", mongodbtests.AutomationConfigReachesVersion(&mdb, 5))
