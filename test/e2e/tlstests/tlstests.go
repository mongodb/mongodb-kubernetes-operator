...
func EnableTLS(ctx *e2eutil.Context, mdb *mdbv1.MongoDBCommunity, optional bool) func(*testing.T) {
...
func ExtendCACertificate(ctx *e2eutil.Context, mdb *mdbv1.MongoDBCommunity) func(*testing.T) {
	return func(t *testing.T) {
		...
		_, err = caCertificateClient.Patch(ctx.Ctx, "tls-selfsigned-ca", types.JSONPatchType, payload, metav1.PatchOptions{})
		assert.NoError(t, err)
	}
}

func RotateCertificate(ctx *e2eutil.Context, mdb *mdbv1.MongoDBCommunity) func(*testing.T) {
	return func(t *testing.T) {
...
func RotateCACertificate(ctx *e2eutil.Context, mdb *mdbv1.MongoDBCommunity) func(*testing.T) {
	return func(t *testing.T) {
...
func rotateCertManagerSecret(ctx *e2eutil.Context, secretName types.NamespacedName, t *testing.T) {
