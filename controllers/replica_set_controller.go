...
func (r *ReplicaSetReconciler) createOrUpdateStatefulSet(ctx context.Context, mdb mdbv1.MongoDBCommunity, isArbiter bool) error {
	...
	buildStatefulSetModificationFunction(mdb, r.mongodbRepoUrl, r.mongodbImage, r.mongodbImageType, r.agentImage, r.versionUpgradeHookImage, r.readinessProbeImage)(&set)
	if isArbiter {
...
func buildStatefulSetModificationFunction(mdb mdbv1.MongoDBCommunity, mongodbRepoUrl, mongodbImage, mongodbImageType, agentImage, versionUpgradeHookImage, readinessProbeImage string) statefulset.Modification {
	commonModification := construct.BuildMongoDBReplicaSetStatefulSetModificationFunction(&mdb, &mdb, mongodbRepoUrl, mongodbImage, mongodbImageType, agentImage, versionUpgradeHookImage, readinessProbeImage, true)
